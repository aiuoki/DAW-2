    ...
    <main class="main">
        ...
        <div class="contenido">
            ...
            <table>
                ...
                <tbody>
                        <?php
                            foreach($productos_asc as $producto) {
                                ?> <?php
                                        echo "<tr>";
                                        ...
                                        echo "<input type='hidden' name='precio' value='". $producto['precio_unitario'] ."'>";
                                        echo "<input type='hidden' name='nick' value='". $_SESSION['nick'] ."'>";
                                        echo "<td><button type='submit' name='comprar-producto'>Añadir al carrito</button></td>";
                                        echo "</form>";
                                        echo "</tr>";
                                ?> <?php
                            }
