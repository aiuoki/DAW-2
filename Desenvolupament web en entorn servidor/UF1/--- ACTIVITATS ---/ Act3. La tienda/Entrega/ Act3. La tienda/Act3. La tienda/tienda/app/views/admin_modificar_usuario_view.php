...
<head>
    ...
    <?php
        ...
        if($select_error != null) {
            ?> <style>.select-error{display: flex;}</style> <?php
        }
        if($nick_error != null) {
    ...
    <main class="main">
        ...
        <div class="contenido"> 
            <form class="form" action="" method="post" novalidate>
                ...
                <button type="submit" name="modificar-usuario">Modificar usuario</button>
